...
import Foundation
    ...
    private func sendfileImpl(
        _ source: UnsafeMutablePointer<FILE>, _ target: Int32, _: off_t,
        _: UnsafeMutablePointer<off_t>, _: UnsafeMutablePointer<sf_hdtr>, _: Int32
    ) -> Int32 {
...
extension Socket {
    ...
    public func writeFile(_ file: String.File) throws {
        ...
        #else
            let result = sendfile(
                fileno(file.pointer), self.socketFileDescriptor, 0, &offset, &sf, 0)
        #endif
