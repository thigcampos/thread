...
public func demoServer(_ publicDir: String) -> HttpServer {
    ...
    server["/magic"] = {
        .ok(.htmlBody("You asked for " + $0.path), ["XXX-Custom-Header": "value"])
    }
    ...
    server.GET["/login"] = scopes {
        html {
            head {
                ...
                stylesheet {
                    href = "http://cdn.staticfile.org/twitter-bootstrap/3.3.0/css/bootstrap.min.css"
                }
            }
            body {
                h3 { inner = "Sign In" }
        ...
        html {
            body {
                center {
                    ...
                    img {
                        src =
                            "https://devimages.apple.com.edgekey.net/swift/images/swift-hero_2x.png"
                    }
                }
            }
        }
    ...
    server["/raw"] = { _ in
        return HttpResponse.raw(
            200, "OK", ["XXX-Custom-Header": "value"], { try $0.write([UInt8]("test".utf8)) })
    }
